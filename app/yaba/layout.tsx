...
export const metadata: Metadata = {
  ...
  description:
    "Ikad Hotel Yaba (formerly Coolio Hotel), 270 Borno Way: comfortable Standard and Deluxe rooms from ₦25,000/night with 24/7 power, free secure parking, weekend live sports at the restaurant, conference room and free Wi-Fi.",
