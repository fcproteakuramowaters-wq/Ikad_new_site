          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              ...
              <p className="text-gray-700">
                ...
                <a href="mailto:yaba@ikadhotel.com" className="hover:opacity-75" style={{ color: "var(--gold)" }}>
                  yaba@ikadhotel.com
                </a>
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow">
              ...
              <div className="space-y-4 text-lg text-gray-700">
                ...
                <p>
                  ...
                  <a href="mailto:yaba@ikadhotel.com" className="hover:opacity-75" style={{ color: "var(--gold)" }}>yaba@ikadhotel.com</a>
                </p>
              </div>
            </div>
          </div>
