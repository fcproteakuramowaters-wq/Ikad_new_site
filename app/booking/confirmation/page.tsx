      ...
      <div className="max-w-2xl mx-auto w-full">
        ...
        <div className="bg-white rounded-lg shadow-lg p-12 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Thank you for choosing Ikad Hotels Victoria Island. Your booking has
          ...
          <div className="bg-blue-50 border border-blue-200 p-6 mb-8 text-left rounded-lg">
            ...
            <div className="space-y-1 text-sm text-blue-900">
              <p>
                ...
                <a href="tel:+2349163738458" className="text-blue-600 hover:underline">
                  +234 916 373 8458
                </a>
              </p>
              <p>
                <span className="font-semibold">Email:</span>{" "}
                <a href="mailto:victoria@ikadhotel.com" className="text-blue-600 hover:underline">
                  victoria@ikadhotel.com
                </a>
              </p>
              <p>
                <span className="font-semibold">WhatsApp:</span>{" "}
                <a
                  href="https://wa.me/2349163738458"
                  target="_blank"
